...
//        }
	...
	EditorUi.prototype.updateUi = function()
	{
		...
		var libsEnabled = urlParams['menu']==1 && (urlParams['embed'] != '1' ||
				this.editor.graph.isEnabled());
		...
		var editable = urlParams['menu']==1 && ((urlParams['embed'] == '1' &&
			this.editor.graph.isEnabled()) ||
